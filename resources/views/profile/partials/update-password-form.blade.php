<section>
    <header>
        ...
        <p class="mt-1 text-sm text-gray-600">
            {{ __('Upewnij się, że Twoje hasło jest wystarczająco długie i bezpieczne.') }}
        </p>
    </header>
    ...
    <form method="post" action="{{ route('password.update') }}" class="mt-6 space-y-6">
        ...
        <div>
            <x-input-label for="update_password_password_confirmation" :value="__('Powtórz nowe hasło')" />
